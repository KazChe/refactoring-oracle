from parking import evening_discount, fee, receipt
...
def test_evening_discount_function():
    assert evening_discount(10.0, 20) == 8.0
    assert evening_discount(10.0, 12) == 10.0
